                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <p class="card-text fuente-R icono-20">
                            ...
                            formado parte de la familia Huellitas para poco a poco, conseguir el prestigio y renombre
                            que tanto la caracteriza.
                            Los años de experiencia han forjado un gran sentido de la empatía y bondad en cada uno de
                            los médicos de la empresa; Gracias a esto y su enorme vocación, hoy en día Huellitas cuenta
                            con 7 sucursales distribuidas a lo largo de la comarca lagunera, cada una de ellas
                            ofreciendo siempre la misma calidad, confort y confianza a sus clientes.
                        </p>
                    </div>
                </div>
            </div>
...
<!--Servicios-->
<div class="container-fluid columna" id="servicios">
    <div class="fila">
        <div class="card mb-3 borde-redondo">
            <div class="row no-gutters centrado-vertical">
                <div class="col-md-6">
...
<div class="fila text-center bg-naranja">
    ...
    <div class="fila centrado-vertical">
        <div class="d-flex justify-content-center">
            <div class="align-self-center"><button class="btn bg-blanco"
                    onclick="carruselder(document.getElementById('marco1'),document.getElementById('marco2'),document.getElementById('marco3'),'<?php echo RUTA_IMG?>/imgcar')"><span
                        class="material-icons icono-270deg icono-40 naranja">pets</span></button></div>
            <div class="d-none d-md-block align-self-center"><img src="<?php echo RUTA_IMG?>/imgcar2.png" id="marco1"
                    width="200"></div>
            <div class="align-self-center"><img src="<?php echo RUTA_IMG?>/imgcar3.png" id="marco2" width="300"></div>
            <div class="d-none d-md-block align-self-center"><img src="<?php echo RUTA_IMG?>/imgcar4.png" id="marco3"
                    width="200"></div>
            <div class="align-self-center"><button class="btn bg-blanco"
                    onclick="carrsuelizq(document.getElementById('marco1'),document.getElementById('marco2'),document.getElementById('marco3'),'<?php echo RUTA_IMG?>/imgcar')"><span
                        class="material-icons icono-90deg icono-40 naranja">pets</span></button></div>
        </div>
    </div>
</div>
<div class="container-fluid columna">
...
<div class="borde-sup borde-g borde-naranja">
    ...
    <div class="text-center fila" id="contacto">
        ...
        <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d819.2744283765471!2d-103.39929423733645!3d25.551791727570073!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x868fdb05e1f740dd%3A0xb416713ea5a71288!2sCalle%20Av%20Costa%20Rica%20294%2C%20Col%20Salvador%20Allende%2C%2027050%20Torre%C3%B3n%2C%20Coah.!5e0!3m2!1ses-419!2smx!4v1596939648248!5m2!1ses-419!2smx"
