...
<tbody>
                        <tr>
                            ...
                            <tr>
                                <td>Día</td>
                                <td>
                                    <input type="text" id="datepicker" name="fecha" value ="<?php echo date("d/m/Y")?>" readonly placeholder="Selecciona un día" required>
                                </td>
                            </tr>
                            <tr>
                                <td>Hora</td>
                            ...
                            <tr>
                                ...
                                <td>
                                <input class="txb" type="text" name="ap_paterno" id="lastname" size="30" <?php $validador -> mostrar_ap_paterno();?>>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                <input class="txb" type="text" name="ap_materno" id="lastname" size="30" <?php $validador -> mostrar_ap_materno();?>>
                                </td>
                            </tr>
