<table class="table table-hover table-striped text-center icono-15">
    ...
    <tbody>
        <tr>
            <td colspan="2"><?php $validador -> mostrar_error_nombres();?></td>
        </tr>
        <tr>
            <td>Nombre(s)</td>
        ...
        <tr>
            <td colspan="2"><?php $validador -> mostrar_error_ap_paterno();?></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2"><?php $validador -> mostrar_error_ap_materno();?></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2"><?php $validador -> mostrar_error_correo();?></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2"><?php $validador -> mostrar_error_nom_usuario();?></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2"><?php $validador -> mostrar_error_clave_1();?></td>
        </tr>
        <tr>
            <td>Contraseña</td>
            <td>
        ...
        <tr>
            <td colspan="2"><?php $validador -> mostrar_error_clave_2();?></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2"><?php $validador -> mostrar_error_telefono();?></td>
        </tr>
        <tr>
            <td>Telefono</td>
            <td>
