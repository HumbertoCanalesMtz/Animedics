...
<tbody>
    <tr>
        <th>Nombre(s)</th>
        <td><input class="txb<?php if ($clase == 'admin') {echo '-gris';}elseif ($clase == 'vet') {echo '-naranja';}?>" type="text" name="nombres" id="names" size="30"
                value="<?php echo $usuario -> obtener_nombres()?>"></td>
    </tr>
    <tr>
        ...
        <td><input class="txb<?php if ($clase == 'admin') {echo '-gris';}elseif ($clase == 'vet') {echo '-naranja';}?>" type="text" name="ap_paterno" id="lastname" size="30"
                value="<?php echo $usuario -> obtener_ap_paterno()?>"></td>
    </tr>
    <tr>
        ...
        <td><input class="txb<?php if ($clase == 'admin') {echo '-gris';}elseif ($clase == 'vet') {echo '-naranja';}?>" type="text" name="ap_materno" id="lastname" size="30"
                value="<?php echo $usuario -> obtener_ap_materno()?>"></td>
    </tr>
    <tr>
        ...
        <td><input class="txb<?php if ($clase == 'admin') {echo '-gris';}elseif ($clase == 'vet') {echo '-naranja';}?>" type="text" name="nombre_usuario" id="nick" size="30"
                value="<?php echo $usuario -> obtener_nombre_usuario()?>"></td>
    </tr>
    <tr>
        <th>Correo electronico</th>
        <td><input class="txb<?php if ($clase == 'admin') {echo '-gris';}elseif ($clase == 'vet') {echo '-naranja';}?>" type="text" name="correo" id="email" size="30"
                value="<?php echo $usuario -> obtener_correo()?>"></td>
    </tr>
    <tr>
        <th>Telefono</th>
        <td><input class="txb<?php if ($clase == 'admin') {echo '-gris';}elseif ($clase == 'vet') {echo '-naranja';}?>" type="text" name="telefono" id="phone" size="30"
                value="<?php echo $usuario -> obtener_telefono()?>"></td>
    </tr>
    <tr>
